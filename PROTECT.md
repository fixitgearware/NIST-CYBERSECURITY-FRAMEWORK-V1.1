...
<strong> PR.IP-7: </strong> Protecting the organization should be a continuous one, and constantly improved. <br> 
...
<td><strong>Protective Technology</strong></td><td><strong>PR.PT</strong></td><td><strong>Technical Security: </strong><br>  Technical Security solutions are to be properly managed, ensuring the security and resillience of systems, and assets are consistent with regards policies, procedures, and agreements. 
</td><td><strong>PR.PT-1, PR.PT-2, PR.PT-3, PR.PT-4 </strong></td><td><strong>PR.PT-1:</strong>Audit/log records are determined, documented, Implemented, and reviewed in accordance with organizations policy. <br><strong>PR.PT-2:</strong>Removable medias and devices are to be protected, and its usage is to be restricted in accordance to organizations policy.                                   <br><strong>PR-PT-3:</strong>Security control implementation to systems and assets, incorporating the principle of least functionality.                                                                                      <br><strong>PR.PT-4:</strong>All medium of communications, and control networks are protected.    
</td>
</tr>
